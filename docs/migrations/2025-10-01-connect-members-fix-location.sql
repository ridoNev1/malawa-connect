-- Patch: Use presence.location_id as primary source for location when online
-- Also expose location_name consistently in members and member detail RPCs

-- A) get_members_org5: add presence.location_id and derive location_name
...
-- B) get_member_detail_org5: join to location via presence.location_id when online
